...
var modelName; modelName = undefined;
...
function recalculate () {
    ...
    document.getElementById("calculate-cost").innerHTML=costLabel
}
...
function changeDuration () {
    ...
    duration = prompt("Please Enter a Duration");
